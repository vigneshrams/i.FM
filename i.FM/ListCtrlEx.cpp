...
int CListCtrlEx::CompareInt(LPCWSTR pLeftText, LPCWSTR pRightText)
{
	return (int)(_wtol(pLeftText) - _wtol(pRightText));
}
int CListCtrlEx::CompareDouble(LPCWSTR pLeftText, LPCWSTR pRightText)
{
	return (int)(_wtof(pLeftText) - _wtof(pRightText));
}
int CListCtrlEx::CompareString(LPCWSTR pLeftText, LPCWSTR pRightText)
{
	return CString(pLeftText).Compare(pRightText);
}
int CListCtrlEx::CompareNumberString(LPCWSTR pLeftText, LPCWSTR pRightText)
{
...
int CListCtrlEx::CompareNumberStringNoCase(LPCWSTR pLeftText, LPCWSTR pRightText)
{
	LONGLONG l1 = _wtol(pLeftText);
	LONGLONG l2 = _wtol(pRightText);
	if(l1 && l2 && (l1 - l2))
...
int CListCtrlEx::CompareStringNoCase(LPCWSTR pLeftText, LPCWSTR pRightText)
{
	return CString(pLeftText).CompareNoCase(pRightText);
}
int CListCtrlEx::CompareDate(LPCWSTR pLeftText, LPCWSTR pRightText)
{
	COleDateTime dL, dR;
